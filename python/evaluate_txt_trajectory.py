...
def load_txt_trajectory(txt_path, t_min=None, t_max=None, t_B_prism=None):
    ...
    data = np.loadtxt(txt_path, skiprows=1, delimiter=delimiter)
...
if __name__ == "__main__":
    pred_path = "./Log/result/shawan_tunnel.txt"
    gt_path = "./python/ground_truth/shawan_tunnel_odom.txt"
    t_B_prism = np.array([0, 0, 0])

    result = evaluate_txt_trajectory(pred_path, gt_path, t_B_prism, visualize=True, align_fraction=1)
