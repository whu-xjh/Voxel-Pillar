...
def main():
    bag_file = "/media/xjh/Extreme SSD/data/rosbag/livox/tunnel03_2025-12-19-16-57-54.bag"
    output_file = "./evaluate/ground_truth/shawan_tunnel_back_odom.txt"
    topic = '/novatel/oem7/odom'
    
    try:
        extract_odom_data(bag_file, output_file, topic)
